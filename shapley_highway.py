...
args = get_arguments()
task_name = 'compute shapley (highway)'
...
for i in tqdm(range(args.start_id, args.end_id)):
    ...
    a_train_list.append(read_gz_file(osp.join(args.train_data_folder, f'action_{i}.gz')))

group_size = 100
group_num = args.end_id - args.start_id
...
s_train_all = s_train_list
y_train_all = y_train_list
a_train_all = a_train_list
...
a_test = read_gz_file(osp.join(args.valid_data_folder, f'action_{valid_id}.gz'))

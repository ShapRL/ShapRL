...
from batch_rl.fixed_replay.agents import dqn_agent_test_base
...
@gin.configurable
class FixedReplayDQNAgentTest(dqn_agent_test_base.DQNAgent):
  ...
  def __init__(self, sess, num_actions, replay_data_dir, replay_suffix=None,
    ...
    super(FixedReplayDQNAgentTest, self).__init__(sess, num_actions, **kwargs)
  ...
  def end_episode(self, reward):
    ...
    super(FixedReplayDQNAgentTest, self).end_episode(reward)

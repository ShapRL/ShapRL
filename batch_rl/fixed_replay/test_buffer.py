...
# from batch_rl.fixed_replay import run_experiment_test_buffer
from batch_rl.fixed_replay import run_experiment_test_buffer_new
...
flags.DEFINE_integer('start_id', 0, 'start id of the buffers loaded')
flags.DEFINE_integer('end_id', 50, 'end id of the buffers loaded')
flags.DEFINE_bool('backdoor', False, 'whether to generate backdoored features')
...
def main(unused_argv):
  ...
  runner = run_experiment_test_buffer_new.TestRunner(FLAGS.base_dir, 
                                                 FLAGS.model_path, 
                                                 create_agent_fn,
                                                 backdoor=FLAGS.backdoor)
  runner.run_experiment(FLAGS.start_id, FLAGS.end_id)

...
@gin.configurable
class FixedReplayRunnerBuffer(run_experiment.Runner):
  """Object that handles running Dopamine experiments with fixed replay buffer."""

  def _initialize_checkpointer_and_maybe_resume(self, checkpoint_file_prefix):
    super(FixedReplayRunnerBuffer, self)._initialize_checkpointer_and_maybe_resume(
  ...
  def _run_one_iteration(self, iteration=0):
    ...
    print('loading replay buffer done!')
